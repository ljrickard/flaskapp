#!/bin/bash
set -euo pipefail
VIRTUAL_ENV_DIRECTORY='/home/ubuntu/deploy/flaskapp/virtual_env'
VIRTUAL_ENV_PACKAGE='/home/ubuntu/deploy/flaskapp/virtualenv-15.1.0'
VIRTUAL_ENV_TAR='/home/ubuntu/deploy/flaskapp/virtualenv-15.1.0.tar.gz'
PY_CACHE_DIRECTORY='/home/ubuntu/deploy/flaskapp/__pycache__'
