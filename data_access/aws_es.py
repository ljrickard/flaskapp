...
FILTER_BRAND_BODY_FILE = 'data_access/json_files/es_filter_brand.json'
PRODUCT_SCHEMA_FILE = 'data_access/json_files/es_product_schema.json'
ELASTIC_SEARCH_ENDPOINT = 'http://127.0.0.1:9200'
INDEX = 'products'
TYPE = 'skincare'
